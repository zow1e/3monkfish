...
/**
 * Embed query, retrieve FAQ/guide chunks, and return a chat completion (education only).
 * @param petId — optional UUID in `public.pets`; if missing or not found, answers without profile.
 */
export async function runRagAnswer(question: string, petId?: string | null): Promise<string> {
